...
export default function ToysPage() {
        ...
        async function fetchProducts() {
            try {
                const res = await fetch(
                    'https://api.escuelajs.co/api/v1/products/?categoryId=5&offset=0&limit=40'
                )
    ...
    return (
        <main className="mx-auto max-w-7xl px-4 pt-28 pb-10">
            <h1 className="text-center text-lg font-medium mb-6">Toys</h1>
            ...
            <section className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-42xl:px-25 xl:px-25 px-10  ">
